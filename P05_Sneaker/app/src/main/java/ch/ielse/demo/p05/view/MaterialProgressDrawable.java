...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float MAX_PROGRESS_ARC = .9f;
...
//            private int mColorIndex;
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            c.save();
            c.rotate(90, bounds.centerX(), bounds.centerY());
            mArcPaint.setColor(mColors[1]);
            c.drawArc(arcBounds, startAngle, sweepAngle, false, mArcPaint);
            c.restore();

            c.save();
            c.scale(1.5f, 1.5f, bounds.centerX(), bounds.centerY());
            c.rotate(180, bounds.centerX(), bounds.centerY());
            mArcPaint.setColor(mColors[0]);
            c.drawArc(arcBounds, startAngle, sweepAngle, false, mArcPaint);
