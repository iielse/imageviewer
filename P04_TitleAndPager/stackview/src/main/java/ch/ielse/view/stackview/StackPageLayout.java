package ch.ielse.view.stackview;
...
import ielse.ch.stack.R;

public class StackPageLayout extends FrameLayout {
...
//    private FrameLayout mLastPage;
    ...
    public StackPageLayout(Context context) {
        this(context, null);
    }

    public StackPageLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
